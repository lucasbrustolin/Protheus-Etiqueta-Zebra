...
* Compile os fontes que estão no diretório /src
* Copie o diretório ./resource/zebra para dentro do seu RootPath.
* Appenda as tabelas utilizadas no cfg. SX2, SX3, SIX, SXB e SX5 em DBF/CTREE ( ./resource/zebra/dbf/ ou   /resource/zebra/ctree)
